 ...
 */
public class RightProfile extends Command {
    ...
    public RightProfile(double riseTime, double dist, double maxSpeed) {
    ...
    protected void initialize() {
    	...
    	feedforward = 0;
    	first = riseTime == 0; // Cancels acc phase if no acceleration is desired
    	second = false;
    	done = false;
    }
